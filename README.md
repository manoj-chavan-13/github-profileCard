...
You can use the hosted API directly in your GitHub profile `README.md`! Just add the following Markdown or HTML snippet and replace `manoj-chavan-13` with any username you'd like.
